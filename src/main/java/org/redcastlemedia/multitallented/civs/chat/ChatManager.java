...
public class ChatManager {
    ...
    public void formatAndSendMessage(Player source, Civilian civilian, ChatChannelConfig config,
        ...
        Audience consoleAudience = Bukkit.getConsoleSender();
        consoleAudience.sendMessage(parse);
    ...
    public void load() {
        // No-op: Paper's Player/CommandSender implement Audience natively, so there is no
        // separate Audience provider to initialize anymore (adventure-platform-bukkit removed).
    }

    public void onDisable() {
        // No-op: nothing to close since BukkitAudiences is no longer used.
    }
