...
public class DeathListenerTests extends TestUtil {
    ...
    public void onBefore() {
        ...
        when(player1.getAttribute(ArgumentMatchers.any(Attribute.class))).thenReturn(mockAttribute);
        ...
        when(player2.getAttribute(ArgumentMatchers.any(Attribute.class))).thenReturn(mockAttribute);
        this.player3 = mock(Player.class);
        when(player3.getAttribute(ArgumentMatchers.any(Attribute.class))).thenReturn(mockAttribute);
