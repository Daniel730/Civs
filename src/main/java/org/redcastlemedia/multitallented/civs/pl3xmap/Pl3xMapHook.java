        ...
        try {
            ...
            if (pl3xMap != null &&
                ...
                try {
                    ...
                    Civs.logger.log(Level.SEVERE, "Unable to create pl3xmap marker for town type " + town.getType(), npe);
                }
            }
    ...
    private static void createMarker(Region region) {
        ...
        if (pl3xMap != null &&
            ...
            try {
                ...
                Civs.logger.log(Level.SEVERE, "Unable to create pl3xmap marker for region type " + region.getType(), npe);
            }
        }
    }
