...
public class MemberActionMenu extends CustomMenu {
    ...
    public ItemStack createItemStack(Civilian civilian, MenuIcon menuIcon, int count) {
        ...
        boolean govTypeMemberOverride = false;
        if (town != null) {
            ...
            govTypeMemberOverride = !"".equals(role) &&
        ...
        if ("icon".equals(menuIcon.getKey())) {
            ...
            if (isAdmin || govTypeMemberOverride || ((!viewingSelf || governmentType == GovernmentType.OLIGARCHY || isOwner) &&
            ...
            if (!isAdmin && (viewingSelf || !(isOwner || govTypeMemberOverride))) {
                return new ItemStack(Material.AIR);
            }
            ...
            if (!viewingSelf && !isOwner && !(isAdmin || govTypeMemberOverride)) {
                return new ItemStack(Material.AIR);
            }
